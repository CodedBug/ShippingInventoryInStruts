...
<body id="top">
	...
	<div class="wrapper row3">
       ...
       |
        <logic:iterate id="purchase" name="purchaseForm" property="purchaseUnits">
            <html:hidden name="purchaseUnit" property="productId" indexed="true" />
             
                |<bean:write name="purchaseUnit" property="productId" />
                |<bean:write name="purchaseUnit" property="productName" />
                |<html:text name="purchaseUnit" property="quantity" size="30" indexed="true" />
            |
        </logic:iterate>
    ...
    <html:submit>Save</html:submit>
						...
						<tr>
							<td>Hand Flares</td>
							<td></td>
							<td><input type="text" id="Manufacturer" name="hfManufacturer"
								size="10px" value="" />
							</td>
							<td><input type="text" id="Batch_Number" name="hf"
								size="10px" value="" />
							</td>
