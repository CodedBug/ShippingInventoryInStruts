...
<body id="top">
	...
	<div class="wrapper row3">
		...
		<div id="table" class="hoc clear">
			...
			<form id="createService" class="" method="post">
				...
				<table id="example-table">
					...
					<tr>
						<td>Service On</td>
						<td><input type="text" id="Date" name="serviceOn"
							class="Date" size="15px" value="MM/DD/YYYY" /></td>

						<td>Next Due</td>
						<td><input type="text" id="Date" name="nextDue" class="Date"
						...
						<tr>
							<td><select id="select_water1" name="selectWater1">
									<option value="" selected="selected">Please select an
										option</option>
									<logic:iterate name="listPurchaseUnit" id="listPurchaseUnitID">
										<logic:equal name="listPurchaseUnitID" property="itemName"
											value="WATER">
											<option
												value="<bean:write name="listPurchaseUnitID" property="batchNo" /> -
											<bean:write name="listPurchaseUnitID" property="manufacturer" /> - 
											<bean:write name="listPurchaseUnitID" property="quantityLeft" /> -
											<bean:write name="listPurchaseUnitID" property="expiryDate" />">
												<bean:write name="listPurchaseUnitID" property="batchNo" />
												-
												<bean:write name="listPurchaseUnitID"
				...
				<table style="width: 300px; float: left;">
					...
					<tbody>
						<tr>
							...
							<td>WP Test</td>
							<td><input type="text" id="Date" name="wpTest" class="Date"
								size="10px" value="MM/DD/YYYY" />
							</td>
						</tr>
						<tr>
							<td>NAP</td>
							<td><input type="text" id="Date" class="Date" name="nap"
								size="10px" value="MM/DD/YYYY" />
							</td>
						</tr>
						<tr>
							...
							<td>Floor Screen</td>
							<td><input type="text" id="Date" class="Date"
								name="floorScreen" size="10px" value="MM/DD/YYYY" />
							</td>
						</tr>
					</tbody>
